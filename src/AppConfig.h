...
// Hand-built, deterministic demonstration Genome (not trained/evolved):
// kInputCount Input nodes (matching Observation slot order), 1 Bias, 3 Output
